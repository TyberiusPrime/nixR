...
"rhdf5"
 ...
 "benchmarkfdrData2019_1.18.0-3.19" = {"d" = {"doCheck" = false;
};
 ...
 "ALL_1.42.0-3.17" = {"s" = "d1951905dea24bb4efe987ee2c22375b6de7ae6d5f4c47a2ec52ea23a6d65f7e";
 "r" = [ "Biobase" ];
};
...
"tibble"
 ...
 "aracne.networks_1.30.0-3.19" = {"r" = [ "viper" ];
 "s" = "a613d8dc7f996d901a89a1b748f56af4930eab220f824730c843479e6cd0dff5";
};
...
"minfi"
 ...
 "muscData_1.14.0-3.17" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" "SingleCellExperiment" ];
 ...
 "PhyloProfileData_1.16.0-3.18" = {"c" = true;
...
"quadprog"
 ...
 "NestLink_1.6.0-3.12" = {"d" = {"doCheck" = false;
};
...
"SummarizedExperiment"
 ...
 "HCAData_1.10.0-3.14" = {"s" = "2b7040d74707c20e6f19344d635bce122dbe97d65b829df3415199af47680451";
 "r" = [ "AnnotationHub" "ExperimentHub" "HDF5Array" "SingleCellExperiment" ];
 "d" = {"doCheck" = false;
};
};
...
"ape"
 ...
 "AmpAffyExample_1.44.0-3.19" = {"s" = "78a0a441f5e79ef935dc7cabb3209b9c335b79786da81d39fb0efda258a4aa48";
 "r" = [ "affy" ];
};
...
"minfi"
 ...
 "TENxPBMCData_1.14.0-3.15" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "HDF5Array" "SingleCellExperiment" ];
...
"SummarizedExperiment"
 ...
 "CellMapperData_1.28.0-3.18" = {"d" = {"doCheck" = false;
};
...
"minfi"
 ...
 "TENxBrainData_1.22.0-3.18" = {"r" = [ "AnnotationHub" "ExperimentHub" "HDF5Array" "SingleCellExperiment" ];
 "d" = {"doCheck" = false;
};
...
"ape"
 ...
 "HumanAffyData_1.24.0-3.16" = {"d" = {"doCheck" = false;
};
 "r" = [ "Biobase" "ExperimentHub" ];
...
"SummarizedExperiment"
 ...
 "JASPAR2014_1.40.0-3.19" = {"r" = [ "Biostrings" ];
 "s" = "73c7ae2a359b33df0eada74a5bcaa7051402dae6d2c92addfc567f74ee368f54";
};
...
"SummarizedExperiment"
 ...
 "MetaGxPancreas_1.16.0-3.15" = {"r" = [ "AnnotationHub" "ExperimentHub" "S4Vectors" "SummarizedExperiment" "impute" ];
...
"ensembldb"
 ...
 "chipseqDBData_1.8.1-3.13" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "Rsamtools" "S4Vectors" ];
...
"cytomapper"
 ...
 "bodymapRat_1.12.0-3.15" = {"d" = {"doCheck" = false;
};
...
"S4Vectors"
 ...
 "restfulSEData_1.26.0-3.19" = {"r" = [ "DelayedArray" "ExperimentHub" "HDF5Array" "SummarizedExperiment" ];
...
"minfi"
 ...
 "pwrEWAS.data_1.12.0-3.16" = {"r" = [ "ExperimentHub" ];
...
"quadprog"
 ...
 "TENxBrainData_1.18.0-3.16" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "HDF5Array" "SingleCellExperiment" ];
...
"org.Mm.eg.db"
 ...
 "TENxVisiumData_1.12.0-3.19" = {"s" = "1a4a58e5e3f9c8c35d736b926d0891c2f8c8674a67d4dbacc1244e8077c14c22";
 "r" = [ "ExperimentHub" "SpatialExperiment" ];
 "d" = {"doCheck" = false;
};
};
...
"graph"
 ...
 "TabulaMurisSenisData_1.10.0-3.19" = {"r" = [
"AnnotationHub"
"ExperimentHub"
"HDF5Array"
"SingleCellExperiment"
...
"rmarkdown"
 ...
 "tuberculosis_1.6.0-3.17" = {"s" = "ff09b71fae7e24520d1ccd5e0f2ae9b726404d54eed658f0c698b49efcf51bd3";
 "d" = {"doCheck" = false;
};
 "r" = [
"AnnotationHub"
