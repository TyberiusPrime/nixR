...
"viridisLite"
 ...
 "nullrangesData_1.4.0-3.16" = {"d" = {"doCheck" = false;
};
...
"rtracklayer"
 ...
 "HumanAffyData_1.20.0-3.14" = {"d" = {"doCheck" = false;
};
...
"tidyr"
 ...
 "DuoClustering2018_1.12.0-3.14" = {"s" = "beba6b39ffb33178236ff805a60eeff8d206056795a9d4c94056e8e924a43675";
 "d" = {"doCheck" = false;
};
 "r" = [
"ExperimentHub"
...
"rhdf5"
 ...
 "curatedMetagenomicData_3.0.10-3.13" = {"s" = "e85ae969af7f33ab0501475f5795eff6edd415dc5ea02cee0acb53f9736c6897";
 "d" = {"doCheck" = false;
};
 "r" = [
"AnnotationHub"
...
"org.Mm.eg.db"
 ...
 "PhyloProfileData_1.14.0-3.17" = {"r" = [ "BiocStyle" "Biostrings" "ExperimentHub" ];
...
"tibble"
 ...
 "STexampleData_1.4.5-3.15" = {"r" = [ "ExperimentHub" "SpatialExperiment" ];
...
"viridisLite"
 ...
 "VectraPolarisData_1.4.0-3.17" = {"s" = "ca0106f08763e52618e85ef9655be08d8c2ca381f714ea2cee81061a2d339fec";
 "r" = [ "ExperimentHub" "SpatialExperiment" ];
 "d" = {"doCheck" = false;
};
};
