...
"tibble"
 ...
 "MetaGxPancreas_1.12.1-3.13" = {"r" = [ "SummarizedExperiment" "ExperimentHub" "impute" "S4Vectors" "AnnotationHub" ];
...
"ape"
 ...
 "curatedOvarianData_1.32.0-3.14" = {"r" = [ "affy" "BiocGenerics" ];
...
"tibble"
 ...
 "systemPipeRdata_2.0.1-3.15" = {"r" = [ "Biostrings" "BiocGenerics" "jsonlite" "remotes" ];
...
"S4Vectors"
 ...
 "r" = [ "VariantAnnotation" "BiocGenerics" "S4Vectors" "IRanges" "GenomicRanges" "Biobase" ];
};
...
"ggthemes"
 ...
 "TimerQuant_1.20.0-3.12" = {"r" = [ "shiny" "ggplot2" "gridExtra" "deSolve" "dplyr" "locfit" ];
...
"latticeExtra"
 ...
 "depmap_1.4.0-3.12" = {"r" = [ "dplyr" "ExperimentHub" "AnnotationHub" ];
 "d" = {"doCheck" = false;
};
...
"DelayedMatrixStats"
 ...
 "XhybCasneuf_1.32.0-3.14" = {"r" = [ "affy" "ath1121501cdf" "tinesath1cdf" "RColorBrewer" ];
...
"IlluminaHumanMethylationEPICanno.ilm10b2.hg19"
 ...
 "r" = [ "AnnotationHub" "ExperimentHub" "Biostrings" "gplots" "protViz" "ShortRead" ];
 "d" = {"doCheck" = false;
};
};
...
"IRanges"
 ...
 "FieldEffectCrc_1.6.0-3.15" = {"r" = [ "BiocStyle" "RUnit" "SummarizedExperiment" "ExperimentHub" "AnnotationHub" "DESeq2" ];
...
"AnnotationHub"
 ...
 "MAQCsubset_1.28.0-3.12" = {"r" = [ "affy" "Biobase" "lumi" ];
 ...
 "HumanAffyData_1.22.0-3.15" = {"r" = [ "ExperimentHub" "Biobase" ];
...
"ExperimentHub"
 ...
 "PtH2O2lipids_1.22.0-3.15" = {"r" = [ "xcms" "CAMERA" "LOBSTAHS" ];
...
"GenomicFeatures"
 ...
 "r" = [ "ExperimentHub" "GenomicAlignments" "AnnotationHub" ];
};
 ...
 "Neve2006_0.32.0-3.14" = {"r" = [ "Biobase" "hgu133a.db" "annotate" ];
...
"BumpyMatrix"
 ...
 "MAQCsubset_1.32.0-3.14" = {"r" = [ "affy" "Biobase" "lumi" ];
 ...
 "PhyloProfileData_1.8.0-3.14" = {"r" = [ "ExperimentHub" "Biostrings" "BiocStyle" ];
...
"data.table"
 ...
 "ccTutorial_1.28.0-3.12" = {"r" = [ "Ringo" "affy" "topGO" "Biobase" ];
 ...
 "VariantToolsData_1.18.0-3.14" = {"r" = [ "VariantAnnotation" "BiocGenerics" "GenomicRanges" ];
...
"Matrix"
 ...
 "CLL_1.34.0-3.14" = {"r" = [ "affy" "Biobase" ];
...
"SummarizedExperiment"
 ...
 "LiebermanAidenHiC2009_0.28.0-3.12" = {"r" = [ "KernSmooth" "IRanges" ];
 "s" = "98514664fd72da839f801748d5362c5df353bc458f0a957507adc9a8ce54e18b";
};
 "dorothea_1.2.2-3.12" = {"r" = [ "dplyr" "magrittr" "bcellViper" "viper" ];
...
"HDF5Array"
 ...
 "TENxBrainData_1.12.0-3.13" = {"r" = [ "SingleCellExperiment" "HDF5Array" "AnnotationHub" "ExperimentHub" ];
...
"IRanges"
 ...
 "GSE13015_1.0.0-3.13" = {"r" = [ "Biobase" "GEOquery" "preprocessCore" "SummarizedExperiment" "GEOquery" "Biobase" ];
...
"IlluminaHumanMethylationEPICanno.ilm10b2.hg19"
 ...
 "Fletcher2013a_1.30.0-3.14" = {"r" = [ "limma" "Biobase" "VennDiagram" "gplots" ];
...
"IlluminaHumanMethylation450kanno.ilmn12.hg19"
 ...
 "PhyloProfileData_1.6.1-3.13" = {"r" = [ "ExperimentHub" "Biostrings" "BiocStyle" ];
 ...
 "methylclockData_1.4.0-3.15" = {"r" = [ "ExperimentHubData" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
...
"ExperimentHub"
 ...
 "r" = [ "ExperimentHub" "affy" "limma" "Biobase" "magrittr" "dplyr" "R.utils" "rhdf5" ];
};
 ...
 "easierData_1.0.0-3.14" = {"r" = [ "ExperimentHub" "AnnotationHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
 ...
 "CLLmethylation_1.14.0-3.14" = {"r" = [ "SummarizedExperiment" "ExperimentHub" ];
...
"SummarizedExperiment"
 ...
 "biscuiteerData_1.4.0-3.12" = {"r" = [ "ExperimentHub" "AnnotationHub" "curl" ];
...
"rtracklayer"
 ...
 "ReactomeGSA.data_1.6.0-3.13" = {"r" = [ "limma" "edgeR" "ReactomeGSA" "Seurat" ];
 ...
 "r" = [ "MSnbase" "R.utils" "shiny" "biocViews" "BiocManager" ];
};
...
"IlluminaHumanMethylationEPICanno.ilm10b4.hg19"
 ...
 "harbChIP_1.30.0-3.13" = {"r" = [ "IRanges" "Biobase" "Biostrings" ];
 ...
 "r" = [ "SingleCellExperiment" "ExperimentHub" "AnnotationHub" "HDF5Array" ];
};
 ...
 "BeadArrayUseCases_1.34.0-3.15" = {"r" = [ "beadarray" "limma" "GEOquery" ];
 ...
 "ReactomeGSA.data_1.4.0-3.12" = {"r" = [ "limma" "edgeR" "ReactomeGSA" "Seurat" ];
 ...
 "sesameData_1.8.10-3.12" = {"r" = [ "ExperimentHub" "AnnotationHub" "rmarkdown" "curl" ];
 "d" = {"doCheck" = false;
};
 ...
 "Fletcher2013b_1.30.0-3.14" = {"r" = [ "Fletcher2013a" "RTN" "RedeR" "igraph" "RColorBrewer" ];
...
"BumpyMatrix"
 ...
 "MetaGxOvarian_1.10.0-3.12" = {"r" = [ "Biobase" "lattice" "impute" "AnnotationHub" "ExperimentHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
 ...
 "r" = [ "ExperimentHub" "Biostrings" ];
};
 "XhybCasneuf_1.28.0-3.12" = {"r" = [ "affy" "ath1121501cdf" "tinesath1cdf" "RColorBrewer" ];
...
"magick"
 ...
 "ChimpHumanBrainData_1.28.0-3.12" = {"r" = [ "affy" "qvalue" "limma" "hexbin" "statmod" ];
 ...
 "bodymapRat_1.10.0-3.14" = {"r" = [ "SummarizedExperiment" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
 ...
 "scpdata_1.0.0-3.13" = {"r" = [ "QFeatures" "ExperimentHub" "AnnotationHub" "SingleCellExperiment" "S4Vectors" ];
 "d" = {"doCheck" = false;
};
...
"ggthemes"
 ...
 "ceu1kg_0.28.0-3.12" = {"r" = [ "GGBase" "GGtools" "Biobase" ];
...
"IlluminaHumanMethylationEPICanno.ilm10b4.hg19"
 ...
 "FieldEffectCrc_1.2.0-3.13" = {"r" = [ "BiocStyle" "RUnit" "SummarizedExperiment" "ExperimentHub" "AnnotationHub" "DESeq2" ];
 "d" = {"doCheck" = false;
};
 ...
 "LiebermanAidenHiC2009_0.34.0-3.15" = {"r" = [ "KernSmooth" "IRanges" ];
...
"Biobase"
 ...
 "pumadata_2.26.0-3.12" = {"r" = [ "Biobase" "puma" "oligo" ];
 ...
 "r" = [ "SummarizedExperiment" "ExperimentHub" "DelayedArray" "HDF5Array" ];
 "d" = {"doCheck" = false;
};
};
 ...
 "TENxPBMCData_1.8.0-3.12" = {"r" = [ "SingleCellExperiment" "HDF5Array" "AnnotationHub" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
 "s" = "f474357a512d34055baffe30a01db508a4de06891a3dd2bab7a7e87eab2d55e9";
};
 "ChIC.data_1.16.0-3.15" = {"r" = [ "genomeIntervals" "randomForest" "caret" ];
...
"ensembldb"
 ...
 "BeadArrayUseCases_1.28.0-3.12" = {"r" = [ "beadarray" "limma" "GEOquery" ];
 ...
 "ccTutorial_1.32.0-3.14" = {"r" = [ "Ringo" "affy" "topGO" "Biobase" ];
...
"S4Vectors"
 ...
 "depmap_1.8.0-3.14" = {"r" = [ "dplyr" "ExperimentHub" "AnnotationHub" ];
 ...
 "RforProteomics_1.30.1-3.13" = {"r" = [ "MSnbase" "R.utils" "biocViews" "BiocManager" ];
 ...
 "pRolocdata_1.28.0-3.12" = {"r" = [ "MSnbase" "Biobase" ];
 ...
 "TimerQuant_1.24.0-3.14" = {"r" = [ "shiny" "ggplot2" "gridExtra" "deSolve" "dplyr" "locfit" ];
...
"data.table"
 ...
 "healthyControlsPresenceChecker_1.0.0-3.15" = {"r" = [ "xml2" "GEOquery" "geneExpressionFromGEO" "magrittr" ];
...
"Matrix"
 ...
 "CLL_1.32.0-3.13" = {"r" = [ "affy" "Biobase" ];
 ...
 "scpdata_1.4.0-3.15" = {"r" = [ "QFeatures" "ExperimentHub" "AnnotationHub" "SingleCellExperiment" "S4Vectors" ];
 "d" = {"doCheck" = false;
};
...
"SummarizedExperiment"
 ...
 "RNAinteractMAPK_1.30.0-3.13" = {"r" = [ "sparseLDA" "RNAinteract" "gdata" "MASS" "genefilter" "fields" "lattice" "Biobase" ];
...
"tibble"
 ...
 "Neve2006_0.28.0-3.12" = {"r" = [ "Biobase" "hgu133a.db" "annotate" ];
 ...
 "ObMiTi_1.2.0-3.14" = {"r" = [ "SummarizedExperiment" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
 ...
 "TENxBUSData_1.6.0-3.13" = {"r" = [ "ExperimentHub" "AnnotationHub" "BiocGenerics" ];
...
"Biobase"
 ...
 "curatedCRCData_2.28.0-3.15" = {"r" = [ "nlme" "BiocGenerics" ];
 ...
 "dsQTL_0.28.0-3.12" = {"r" = [ "Biobase" "SummarizedExperiment" "GGBase" ];
 ...
 "DropletTestFiles_1.4.0-3.14" = {"r" = [ "ExperimentHub" "AnnotationHub" "S4Vectors" ];
 "d" = {"doCheck" = false;
};
...
"ape"
 ...
 "GSE13015_1.4.0-3.15" = {"r" = [ "Biobase" "GEOquery" "preprocessCore" "SummarizedExperiment" "GEOquery" "Biobase" ];
...
"Rcpp"
 ...
 "ChimpHumanBrainData_1.34.0-3.15" = {"r" = [ "affy" "qvalue" "limma" "hexbin" "statmod" ];
...
"IlluminaHumanMethylationEPICanno.ilm10b4.hg19"
 ...
 "RNAinteractMAPK_1.28.2-3.12" = {"r" = [ "sparseLDA" "RNAinteract" "gdata" "MASS" "genefilter" "fields" "lattice" "Biobase" ];
 ...
 "MetaGxBreast_1.16.0-3.15" = {"r" = [ "Biobase" "AnnotationHub" "ExperimentHub" "lattice" "impute" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
 ...
 "dorothea_1.6.0-3.14" = {"r" = [ "dplyr" "magrittr" "bcellViper" "viper" ];
...
"tidyr"
 ...
 "MAQCsubsetAFX_1.28.0-3.12" = {"r" = [ "affy" "Biobase" ];
...
"IlluminaHumanMethylation450kanno.ilmn12.hg19"
 ...
 "SomaticCancerAlterations_1.26.0-3.12" = {"r" = [ "GenomicRanges" "exomeCopy" "stringr" "IRanges" "S4Vectors" ];
 "s" = "3024b4874f0b12c9562dc5057a2e8fdd865fb3e51766346c734e2e5aeefb446f";
};
 "curatedBreastData_2.18.0-3.12" = {"r" = [ "XML" "ggplot2" "impute" "Biobase" "BiocStyle" ];
 ...
 "davidTiling_1.32.0-3.13" = {"r" = [ "Biobase" "tilingArray" "GO.db" ];
 ...
 "TMExplorer_1.0.1-3.12" = {"r" = [ "SingleCellExperiment" "Matrix" ];
 "s" = "68d07021b90af7f5d2299b1ffa5b6520f13b27fecc0a7110d80886e92a93b837";
};
 "HD2013SGI_1.30.0-3.12" = {"r" = [ "RColorBrewer" "gplots" "geneplotter" "splots" "limma" "vcd" "LSD" "EBImage" ];
...
"Biobase"
 ...
 "r" = [ "AnnotationHub" "Biobase" "dplyr" "ExperimentHub" "magrittr" "S4Vectors" "tidyr" ];
 "d" = {"doCheck" = false;
};
};
...
"ensembldb"
 ...
 "emtdata_1.0.0-3.13" = {"r" = [ "edgeR" "ExperimentHub" "SummarizedExperiment" ];
...
"DelayedMatrixStats"
 ...
 "PREDAsampledata_0.36.0-3.15" = {"r" = [ "PREDA" "Biobase" "affy" "annotate" ];
...
"data.table"
 ...
 "Fletcher2013b_1.28.0-3.13" = {"r" = [ "Fletcher2013a" "RTN" "RedeR" "igraph" "RColorBrewer" ];
 ...
 "GGdata_1.28.0-3.12" = {"r" = [ "Biobase" "GGBase" "snpStats" "illuminaHumanv1.db" "AnnotationDbi" ];
