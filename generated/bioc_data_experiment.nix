...
"SummarizedExperiment"
 ...
 "spatialLIBD_1.13.4-3.18" = {"d" = {"doCheck" = false;
};
...
"minfi"
 ...
 "TENxBrainData_1.20.0-3.17" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "HDF5Array" "SingleCellExperiment" ];
...
"SummarizedExperiment"
 ...
 "s" = "70c76cb60552b71e2513f4aa338e9ee4bde2aa50f4309b7a1cf3e7ff19780c0a";
 "d" = {"doCheck" = false;
};
};
