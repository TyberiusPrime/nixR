...
"Matrix"
 ...
 "harbChIP_1.32.0-3.14" = {"r" = [ "IRanges" "Biobase" "Biostrings" ];
 ...
 "Fletcher2013b_1.32.0-3.15" = {"r" = [ "Fletcher2013a" "RTN" "RedeR" "igraph" "RColorBrewer" ];
...
"magick"
 ...
 "CellMapperData_1.18.0-3.13" = {"r" = [ "ExperimentHub" "CellMapper" ];
 "d" = {"doCheck" = false;
};
...
"AnnotationHub"
 ...
 "qPLEXdata_1.12.0-3.14" = {"r" = [ "qPLEXanalyzer" "knitr" "MSnbase" "dplyr" ];
...
"HDF5Array"
 ...
 "BeadArrayUseCases_1.30.1-3.13" = {"r" = [ "beadarray" "limma" "GEOquery" ];
 ...
 "PtH2O2lipids_1.18.0-3.13" = {"r" = [ "xcms" "CAMERA" "LOBSTAHS" ];
...
"tibble"
 ...
 "pRolocdata_1.34.0-3.15" = {"r" = [ "MSnbase" "Biobase" ];
...
"einsum"
 ...
 "dorothea_1.4.2-3.13" = {"r" = [ "dplyr" "magrittr" "bcellViper" "viper" ];
...
"GenomicFeatures"
 ...
 "adductData_1.12.0-3.15" = {"r" = [ "ExperimentHub" "AnnotationHub" ];
...
"Rcpp"
 ...
 "curatedCRCData_2.26.0-3.14" = {"r" = [ "nlme" "BiocGenerics" ];
...
"S4Vectors"
 ...
 "DmelSGI_1.24.0-3.13" = {"r" = [ "TSP" "limma" "rhdf5" "knitr" "abind" "gplots" "igraph" ];
...
"FlowSorted.Blood.EPIC"
 ...
 "mcsurvdata_1.14.0-3.15" = {"r" = [ "ExperimentHub" "AnnotationHub" "Biobase" ];
...
"SummarizedExperiment"
 ...
 "curatedBreastData_2.20.0-3.13" = {"r" = [ "XML" "ggplot2" "impute" "Biobase" "BiocStyle" ];
...
"IRanges"
 ...
 "RNAinteractMAPK_1.34.0-3.15" = {"r" = [ "sparseLDA" "RNAinteract" "gdata" "MASS" "genefilter" "fields" "lattice" "Biobase" ];
 ...
 "TENxPBMCData_1.10.0-3.13" = {"r" = [ "SingleCellExperiment" "HDF5Array" "AnnotationHub" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
 ...
 "biscuiteerData_1.8.0-3.14" = {"r" = [ "ExperimentHub" "AnnotationHub" "curl" ];
 "d" = {"doCheck" = false;
};
...
"S4Vectors"
 ...
 "SBGNview.data_1.6.0-3.13" = {"r" = [ "knitr" "rmarkdown" "bookdown" ];
 ...
 "emtdata_1.4.0-3.15" = {"r" = [ "edgeR" "ExperimentHub" "SummarizedExperiment" ];
...
"GenomicFeatures"
 ...
 "CLLmethylation_1.12.0-3.13" = {"r" = [ "SummarizedExperiment" "ExperimentHub" ];
 ...
 "r" = [ "SingleCellExperiment" "BiocFileCache" "data.table" "S4Vectors" "Matrix" ];
};
...
"Matrix"
 ...
 "HighlyReplicatedRNASeq_1.8.0-3.15" = {"r" = [ "SummarizedExperiment" "ExperimentHub" "S4Vectors" ];
...
"Rcpp"
 ...
 "BeadArrayUseCases_1.32.0-3.14" = {"r" = [ "beadarray" "limma" "GEOquery" ];
 "s" = "1944bfb35e1eca272563674e247542297621d45041064b5d0a356c505e2685fe";
};
 "ppiData_0.34.0-3.15" = {"r" = [ "graph" "AnnotationDbi" ];
...
"AnnotationHub"
 ...
 "MetaGxOvarian_1.14.0-3.14" = {"r" = [ "Biobase" "AnnotationHub" "ExperimentHub" "SummarizedExperiment" "lattice" "impute" ];
 "d" = {"doCheck" = false;
};
...
"ggthemes"
 ...
 "curatedAdipoChIP_1.10.0-3.14" = {"r" = [ "SummarizedExperiment" "ExperimentHub" ];
...
"tidyr"
 ...
 "dyebiasexamples_1.32.0-3.13" = {"r" = [ "marray" "GEOquery" ];
...
"IlluminaHumanMethylation450kanno.ilmn12.hg19"
 ...
 "r" = [ "SingleCellExperiment" "BiocFileCache" "Matrix" ];
};
...
"IlluminaHumanMethylationEPICanno.ilm10b4.hg19"
 ...
 "TENxBUSData_1.8.0-3.14" = {"r" = [ "ExperimentHub" "AnnotationHub" "BiocGenerics" ];
...
"rtracklayer"
 ...
 "MetaGxOvarian_1.12.0-3.13" = {"r" = [ "Biobase" "lattice" "impute" "AnnotationHub" "ExperimentHub" "SummarizedExperiment" ];
...
"FlowSorted.Blood.EPIC"
 ...
 "pumadata_2.28.0-3.13" = {"r" = [ "Biobase" "puma" "oligo" ];
