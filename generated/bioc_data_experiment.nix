...
"minfi"
 ...
 "emtdata_1.18.0-3.22" = {"s" = "0670885e86fdb4246a81ecc3a51d795ab9802201eb0b6aafa2f29eaa5f4474c7";
...
"jsonlite"
 ...
 "MerfishData_1.8.0-3.20" = {"d" = {"doCheck" = false;
};
...
"sva"
 ...
 "depmap_1.20.0-3.20" = {"d" = {"doCheck" = false;
};
 "s" = "e111a002fe8dc6bdfbb533adfcbac3c8a0ba0862cc384bf893d00c4bba445dd6";
...
"tidyselect"
 ...
 "easierData_1.8.0-3.18" = {"r" = [ "AnnotationHub" "ExperimentHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
...
"org.Mm.eg.db"
 ...
 "MetaGxBreast_1.10.1-3.12" = {"r" = [ "AnnotationHub" "Biobase" "ExperimentHub" "SummarizedExperiment" "impute" "lattice" ];
...
"viridisLite"
 ...
 "SingleMoleculeFootprintingData_1.18.0-3.22" = {"d" = {"doCheck" = false;
};
...
"rhdf5"
 ...
 "mcsurvdata_1.20.0-3.18" = {"r" = [ "AnnotationHub" "Biobase" "ExperimentHub" ];
...
"stringr"
 ...
 "spatialDmelxsim_1.14.0-3.21" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" "SummarizedExperiment" ];
 "s" = "630c4d323436a807fcf3c46ba86e1486165ee841ba2fbd52be834c28adf01b35";
};
...
"viridisLite"
 ...
 "STexampleData_1.8.0-3.17" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" "SpatialExperiment" ];
...
"gdata"
 ...
 "colonCA_1.50.0-3.21" = {"r" = [ "Biobase" ];
 "s" = "c60529d85b24b0b06a1b737cd2dbd3f0818565b3345238883bee11322a73284b";
};
...
"cytomapper"
 ...
 "PhyloProfileData_1.12.0-3.16" = {"r" = [ "BiocStyle" "Biostrings" "ExperimentHub" ];
 ...
 "MetaGxPancreas_1.24.0-3.19" = {"s" = "bb736fdbea413365bb151e4cba1f0bbfffd359eb13880aa0861a0f9ca5381194";
 "d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "S4Vectors" "SummarizedExperiment" "impute" ];
};
...
"ensembldb"
 ...
 "scaeData_1.6.0-3.22" = {"s" = "0cbf761dfcf8b0f950fffaab2c41206c1176e6a818b9dc9252d4b030b1bd0b84";
 "d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" ];
};
...
"SummarizedExperiment"
 ...
 "miRNATarget_1.44.0-3.20" = {"s" = "438554d7f3a9782ce368428c0062975ae359534072227b339b43edb1101c3b2b";
 "r" = [ "Biobase" ];
};
...
"tibble"
 ...
 "timecoursedata_1.14.0-3.19" = {"r" = [ "SummarizedExperiment" ];
 "s" = "7932713069b676fcd5d9d4aef39d6df259dc865de1d62139df5713c955614e72";
};
...
"minfi"
 ...
 "QDNAseq.mm10_1.34.0-3.19" = {"r" = [ "QDNAseq" ];
 "s" = "9dbf77c963dfa717bbbcf9a6a9e884ee19aed1d376a87bad75683c69d91e9222";
};
...
"ensembldb"
 ...
 "ewceData_1.10.0-3.18" = {"s" = "3b55a89ab4ba55741b187a5db944e5595f91d8791d073773a66bd37b412ef0cd";
 "r" = [ "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
};
...
"SummarizedExperiment"
 ...
 "SingleCellMultiModal_1.16.0-3.19" = {"s" = "3832b5ffd1d3757615ce1af3614b4842dbd88652cfbdbfeeba370055f3fdeecf";
 "r" = [
"AnnotationHub"
"BiocBaseUtils"
"BiocFileCache"
...
"xtable"
 ...
 "homosapienDEE2CellScore_1.4.0-3.21" = {"r" = [
"BiocGenerics"
"DESeq2"
"ExperimentHub"
"MatrixGenerics"
...
"tidyselect"
 ...
 "KEGGdzPathwaysGEO_1.48.0-3.22" = {"s" = "991d09aa27687db7d34105d351385ef38293892674537be0af8817f2274c6b86";
 "r" = [ "Biobase" "BiocGenerics" ];
};
...
"org.Mm.eg.db"
 ...
 "DoReMiTra_1.0.0-3.22" = {"r" = [ "AnnotationHub" "ExperimentHub" "S4Vectors" "SummarizedExperiment" "glue" "scater" ];
...
"viridis"
 ...
 "SFEData_1.8.1-3.20" = {"s" = "44d4c3461407ccc570c37498a2c4a60647d43cf2573a4e8cae34b54be6a78ca7";
 "r" = [ "AnnotationHub" "BiocFileCache" "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
};
...
"rmarkdown"
 ...
 "PCHiCdata_1.34.0-3.20" = {"s" = "66b2b861e62fb538883167a51266fb5ca02e35ec7ceeb9e07e09ba4ab4460b84";
 "r" = [ "Chicago" ];
};
 ...
 "HarmonizedTCGAData_1.26.0-3.19" = {"s" = "c7d1bdd5caaf5e3377ec3b33d0e8a59caa7e699c4bcb74d5bb3f146c0b3020fe";
 "d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" ];
};
...
"rtracklayer"
 ...
 "MethylSeqData_1.18.0-3.21" = {"d" = {"doCheck" = false;
};
...
"viridis"
 ...
 "antiProfilesData_1.42.0-3.20" = {"s" = "b765665095c086b4ec48afbb42370100b187a6148f52c0c960f6b89b9c8b2015";
 "r" = [ "Biobase" ];
};
 ...
 "TCGAcrcmRNA_1.30.0-3.22" = {"r" = [ "Biobase" ];
 "s" = "0619f9a0c7f5f4c7938e3477ccb29eb73f3688aee08977959cdc8534dc115e1b";
};
...
"viridisLite"
 ...
 "affycompData_1.44.0-3.20" = {"r" = [ "Biobase" "affycomp" ];
 "s" = "5990676a4d8298356910ef3507e54959a9682f53c2a920c4f86605a685c4a407";
};
...
"SummarizedExperiment"
 ...
 "sesameData_1.28.0-3.22" = {"d" = {"doCheck" = false;
};
 "r" = [
"AnnotationHub"
"ExperimentHub"
...
"rlang"
 ...
 "HumanAffyData_1.28.0-3.18" = {"d" = {"doCheck" = false;
};
 "r" = [ "Biobase" "ExperimentHub" ];
...
"xtable"
 ...
 "curatedPCaData_1.0.0-3.19" = {"s" = "7c3c25fe44045e4d3e117e17d299c797f92745c0cb1daad7c2bed3143e781b73";
 "d" = {"doCheck" = false;
};
 "r" = [
"AnnotationHub"
...
"cytomapper"
 ...
 "DuoClustering2018_1.20.0-3.18" = {"r" = [
"ExperimentHub"
"dplyr"
"ggplot2"
"ggthemes"
...
"SummarizedExperiment"
 ...
 "RUVnormalizeData_1.26.0-3.20" = {"r" = [ "Biobase" ];
 "s" = "11516c65e012fc286b80a9a9a329a5e83fe0b9005c55bacf1955bb25a2cd7ee5";
};
...
"minfi"
 ...
 "imcdatasets_1.12.0-3.19" = {"d" = {"doCheck" = false;
};
...
"sva"
 ...
 "BeadSorted.Saliva.EPIC_1.0.0-3.13" = {"r" = [ "ExperimentHub" "minfi" ];
...
"S4Vectors"
 ...
 "xcoredata_1.4.0-3.17" = {"s" = "da6de4cc5a12806f69ed0ebbb9717c9fb927b1de44ecca5bd362236136927d08";
 "d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" ];
};
...
"SummarizedExperiment"
 ...
 "biscuiteerData_1.22.0-3.21" = {"s" = "c1657bc2a23d762e442e61f8fef2bee60bd124fb459571e3a3c5fc918d49efa6";
...
"rtracklayer"
 ...
 "gDRtestData_1.8.0-3.22" = {"s" = "0163f632ed812c7d068e9c798bf6a58e53793ff0ddc14ce156d4ca112f3e5a7a";
 "r" = [ "checkmate" "data.table" ];
};
...
"gdata"
 ...
 "easierData_1.14.0-3.21" = {"r" = [ "AnnotationHub" "ExperimentHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
...
"tidyselect"
 ...
 "curatedAdipoChIP_1.22.0-3.20" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" "SummarizedExperiment" ];
...
"SummarizedExperiment"
 ...
 "DropletTestFiles_1.16.0-3.20" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "S4Vectors" ];
 ...
 "DropletTestFiles_1.18.0-3.21" = {"r" = [ "AnnotationHub" "ExperimentHub" "S4Vectors" ];
...
"SummarizedExperiment"
 ...
 "GSE103322_1.14.0-3.21" = {"s" = "255837834c8543befe173f48a8bde71b8bfe92e6db54405d3afd849ab1bbec11";
 "r" = [ "Biobase" "GEOquery" ];
};
...
"minfi"
 ...
 "curatedTBData_1.4.0-3.16" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "ExperimentHub" "MultiAssayExperiment" "rlang" ];
...
"tibble"
 ...
 "marinerData_1.6.0-3.20" = {"s" = "27aab555b5e1ebd03fd9bdc621cc7772e38321aeec4a4610f3c100c015bcbd5c";
 "r" = [ "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
};
...
"tidyselect"
 ...
 "PWMEnrich.Dmelanogaster.background_4.40.0-3.20" = {"s" = "5a6a8146fcb5c27176c89c4a3b36c33dce69f1e5c14e1ceb3b0da8ada86f808e";
 "r" = [ "PWMEnrich" ];
};
...
"jsonlite"
 ...
 "STexampleData_1.0.8-3.13" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" "SpatialExperiment" ];
...
"SummarizedExperiment"
 ...
 "scRNAseq_2.22.0-3.21" = {"s" = "1bd56612eca8b30444a574051b6ae2c082195790c91e9cc5659da264f63c8874";
 "r" = [
"AnnotationDbi"
"AnnotationHub"
"BiocGenerics"
...
"readr"
 ...
 "preciseTADhub_1.16.0-3.21" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" ];
...
"tidyr"
 ...
 "s" = "6eaf4db16b9db28630d616701ce41e1674e2663143c010bfaa4a74965f62a437";
};
...
"viridisLite"
 ...
 "raerdata_1.2.0-3.19" = {"d" = {"doCheck" = false;
};
 "r" = [ "BiocGenerics" "ExperimentHub" "Rsamtools" "SingleCellExperiment" "rtracklayer" ];
...
"tidyselect"
 ...
 "MouseThymusAgeing_1.14.0-3.20" = {"r" = [
"BiocGenerics"
"ExperimentHub"
"S4Vectors"
"SingleCellExperiment"
"SummarizedExperiment"
 ...
 "s" = "2e229161c2dcdb43e9c6977417092de2e267baf690b332ec5c5ae847f2266b69";
};
...
"tibble"
 ...
 "CytoMethIC_1.2.0-3.20" = {"d" = {"doCheck" = false;
};
...
"stringr"
 ...
 "CoSIAdata_1.10.0-3.22" = {"r" = [ "ExperimentHub" ];
 ...
 "curatedTBData_1.0.0-3.14" = {"d" = {"doCheck" = false;
};
...
"SummarizedExperiment"
 ...
 "ReactomeGSA.data_1.22.0-3.21" = {"r" = [ "ReactomeGSA" "Seurat" "edgeR" "limma" ];
 "s" = "bfbc6f25991d7b67e3002ae5f2503bdc925056e68a32db053f5b9e67264c5ddd";
};
...
"tidyselect"
 ...
 "PhyloProfileData_1.20.0-3.20" = {"c" = true;
 "d" = {"doCheck" = false;
};
...
"SummarizedExperiment"
 ...
 "golubEsets_1.50.0-3.21" = {"r" = [ "Biobase" ];
 "s" = "fa755b44181a298c612978f9e77a5a52763c289bfe7dfe30b6c81dec071bf0e1";
};
 ...
 "healthyControlsPresenceChecker_1.10.0-3.20" = {"s" = "8cb9b9a0b8c8b9b1a2fab56adbeda5c702d2bda78dfe05dd1a8524ca5f53f4df";
 "r" = [ "GEOquery" "geneExpressionFromGEO" "magrittr" "xml2" ];
};
...
"ensembldb"
 ...
 "SingleMoleculeFootprintingData_1.8.0-3.17" = {"d" = {"doCheck" = false;
};
 "r" = [ "ExperimentHub" ];
...
"quadprog"
 ...
 "gDNAinRNAseqData_1.4.0-3.19" = {"d" = {"doCheck" = false;
};
 "r" = [ "BiocGenerics" "ExperimentHub" "RCurl" "Rsamtools" "XML" ];
...
"ape"
 ...
 "signatureSearchData_1.22.0-3.21" = {"r" = [ "Biobase" "ExperimentHub" "R.utils" "affy" "dplyr" "limma" "magrittr" "rhdf5" ];
 "d" = {"doCheck" = false;
};
...
"minfi"
 ...
 "EpiMix.data_1.4.0-3.18" = {"d" = {"doCheck" = false;
};
...
"cytomapper"
 ...
 "geneLenDataBase_1.32.0-3.15" = {"s" = "5f691667b53acb1769509540bdbdbf7001e5be4973b97a88f5567f8d47ab995c";
 "r" = [ "GenomicFeatures" "rtracklayer" ];
};
...
"rhdf5"
 ...
 "TumourMethData_1.8.0-3.22" = {"d" = {"doCheck" = false;
};
...
"tidyr"
 ...
 "SingleMoleculeFootprintingData_1.14.0-3.20" = {"d" = {"doCheck" = false;
};
...
"tibble"
 ...
 "rcellminerData_2.32.0-3.22" = {"s" = "e31b449747dc292da37e1438e4f2296a1988cb640c334f64af427c4d767f74df";
 "r" = [ "Biobase" ];
};
...
"xlsx"
 ...
 "NestLink_1.26.0-3.22" = {"r" = [ "AnnotationHub" "Biostrings" "ExperimentHub" "ShortRead" "gplots" "protViz" ];
 "d" = {"doCheck" = false;
};
...
"SummarizedExperiment"
 ...
 "MicrobiomeBenchmarkData_1.10.0-3.21" = {"r" = [ "BiocFileCache" "S4Vectors" "SummarizedExperiment" "TreeSummarizedExperiment" "ape" ];
 "s" = "c40081e779c51872294421befb5af474de97d3af796396b4373f4567e67f3d95";
};
...
"rtracklayer"
 ...
 "ObMiTi_1.12.0-3.19" = {"r" = [ "ExperimentHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
...
"stringr"
 ...
 "muscData_1.20.0-3.20" = {"r" = [ "ExperimentHub" "SingleCellExperiment" ];
 "s" = "3971c49cdbdea2794890cb575c98e9bb80325ac1c6ab157f161fed2117c44af8";
 "d" = {"doCheck" = false;
};
};
...
"rhdf5"
 ...
 "dorothea_1.16.0-3.19" = {"r" = [ "bcellViper" "decoupleR" "dplyr" "magrittr" ];
 "s" = "6f31b595838047c767475988874afddbc65a5e6e2fa7f15423d8b8a372304923";
};
...
"xtable"
 ...
 "octad.db_1.8.0-3.20" = {"r" = [ "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
...
"tidyr"
 ...
 "spatialDmelxsim_1.2.0-3.15" = {"r" = [ "ExperimentHub" "SummarizedExperiment" ];
 "d" = {"doCheck" = false;
};
 ...
 "ObMiTi_1.18.0-3.22" = {"d" = {"doCheck" = false;
};
...
"tibble"
 ...
 "TENxBUSData_1.20.0-3.20" = {"d" = {"doCheck" = false;
};
 "r" = [ "AnnotationHub" "BiocGenerics" "ExperimentHub" ];
 ...
 "orthosData_1.8.0-3.22" = {"s" = "847efddf86b8eafb4ba8621b58e87242742611fbe73d0dc4f1faf117c1a954b9";
 "r" = [
"AnnotationHub"
"BiocFileCache"
"ExperimentHub"
...
"sva"
 ...
 "OMICsPCAdata_1.28.0-3.22" = {"r" = [ "MultiAssayExperiment" ];
 "s" = "6f69e19c465998b788ed2ffc2048e5f5471b0e288c8c5ee285fda1f460cbd288";
};
...
"tidyr"
 ...
 "scpdata_1.18.0-3.22" = {"r" = [ "AnnotationHub" "ExperimentHub" "QFeatures" "S4Vectors" "SingleCellExperiment" ];
 "d" = {"doCheck" = false;
};
 ...
 "HCATonsilData_1.2.0-3.19" = {"s" = "e1de1c8150847b79901b9ee5b59cb30b1fffad656d4fa7df02c8f137d8aee0f1";
 "r" = [
"ExperimentHub"
"HDF5Array"
"S4Vectors"
...
"readr"
 ...
 "DNAZooData_1.8.0-3.21" = {"s" = "1246c470202638d10d0c82839c709c3b64265b64fbccc914e262284c6d4de7ce";
 "r" = [ "BiocFileCache" "HiCExperiment" "S4Vectors" "rjson" ];
};
 ...
 "clustifyrdatahub_1.2.0-3.13" = {"r" = [ "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
...
"qvalue"
 ...
 "GenomicDistributionsData_1.14.0-3.20" = {"s" = "852bf88a5ce83eda42e725566cc601a3743dccaa2daadc2910b6d266bb7f4acc";
 "r" = [
"AnnotationFilter"
"AnnotationHub"
"BSgenome"
...
"qvalue"
 ...
 "brainImageRdata_1.8.0-3.12" = {"r" = [ "ExperimentHub" ];
 "d" = {"doCheck" = false;
};
...
"rmarkdown"
 ...
 "DuoClustering2018_1.28.0-3.22" = {"s" = "29eac0ba5d530a8c97d165b542eb98f712a1c8764412fd87574f78d280093051";
 "d" = {"doCheck" = false;
};
 "r" = [
"ExperimentHub"
...
"gdata"
 ...
 "HumanAffyData_1.30.0-3.19" = {"d" = {"doCheck" = false;
};
 "r" = [ "Biobase" "ExperimentHub" ];
 ...
 "TabulaMurisSenisData_1.12.0-3.20" = {"r" = [
"AnnotationHub"
"ExperimentHub"
"HDF5Array"
"SingleCellExperiment"
...
"SummarizedExperiment"
 ...
 "IHWpaper_1.34.0-3.20" = {"s" = "7dc02039d6a13d8e11bfb412ef876ea94ed2f4251dd1003340fb821992dce56d";
 "r" = [
"Biobase"
"BiocGenerics"
"BiocParallel"
